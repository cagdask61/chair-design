export default function Navigation() {
    return (
        <div className='absolute top-0 left-0 z-30 flex flex-row items-center gap-x-3 m-2'>
            <a className='flex flex-row items-center justify-center ring-1 ring-white/20 bg-white/5 hover:bg-white/10 rounded-lg p-2 scale-90' href='https://skfb.ly/6CDY6' target='_blank'>
            ...
            <a className='flex flex-row items-center justify-center ring-1 ring-white/20 bg-white/5 hover:bg-white/10 rounded-lg p-2 scale-90' href='https://github.com/cagdask61/chair-design' target='_blank'>
            ...
            <a className='flex flex-row items-center justify-center ring-1 ring-white/20 bg-white/5 hover:bg-white/10 rounded-lg p-2 scale-90' href='https://cagdaskocaman.com' target='_blank'>
