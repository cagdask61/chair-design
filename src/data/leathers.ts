const leathers = [
    {
        title: "Varsayılan",
        key: "base",
        material: "./textures/leathers/default/material.jpg",
        path: {
    ...
    },
    {
        title: "Zırh",
        key: "armor",
        material: "./textures/leathers/armor/material.jpg",
        path: {
    ...
    },
    {
        title: "Elmas",
        key: "diamon",
        material: "./textures/leathers/diamon/material.jpg",
        path: {
    ...
    },
    {
        title: "Yastıklı",
        key: "padded",
        material: "./textures/leathers/padded/material.jpg",
        path: {
    ...
    },
    {
        title: "Örgü",
        key: "weave",
        material: "./textures/leathers/weave/material.jpg",
        path: {
    ...
    },
    {
        title: "Yeşil",
        key: "green",
        material: "./textures/leathers/green/material.jpg",
        path: {
